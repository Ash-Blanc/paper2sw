...
class DummyDiffusionModel:
    """A deterministic, dependency-free stand-in for the real diffusion model.

    This maps input text to a small set of super-weight predictions using a
    hash-based pseudo-random generator for reproducibility.
    """
    ...
    def predict(self, text: str, top_k: int = 5, seed: int | None = None) -> List[SuperWeightPrediction]:
        ...
        # Build a deterministic seed from text and optional user-provided seed
        ...
        for _ in range(top_k):
            # Ensure coordinates and layer are unique to avoid duplicates
            ...
            # Map RNG to a full-precision value in a reasonable range
